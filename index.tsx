...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (quoteForm) {
        quoteForm.addEventListener('submit', (event) => {
            ...
            const emailList = recipientEmails.join(' and ');
            
            alert(`Thank you, ${name}! Your quote request for ${service} has been received (simulated). A copy has been submitted to ${emailList}. We will contact you at ${email} soon.`);
            quoteForm.reset();
        });
    }
